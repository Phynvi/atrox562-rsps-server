...
public class Class289 {
	...
	public void method2731(int i) {
		try {
			for (int i_0_ = 0; i_0_ < this.anInt3153 * 843157589; i_0_++) {
				for (int i_1_ = 0; i_1_ < -16196483
						* this.anInt3154; i_1_++) {
					if (i_0_ == 0
							|| i_1_ == 0
							|| i_0_ >= this.anInt3153 * 843157589 - 5
							|| i_1_ >= -16196483 * this.anInt3154
									- 5)
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lz.f(").append(')').toString());
		}
	}

	public void method2732(int i, int i_2_, int i_3_, int i_4_, boolean bool,
	...
	void method2735(int i, int i_11_, int i_12_, int i_13_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lz.d(").append(')').toString());
		}
	}

	public void method2736(int i, int i_14_, int i_15_, int i_16_, int i_17_,
			boolean bool, boolean bool_18_, byte i_19_) {
		try {
			int i_20_ = 256;
			if (bool)
				i_20_ |= 0x20000;
			...
			for (int i_22_ = i; i_22_ < i + i_15_; i_22_++) {
				if (i_22_ >= 0
						&& i_22_ < 843157589 * this.anInt3153) {
					for (int i_23_ = i_14_; i_23_ < i_14_ + i_16_; i_23_++) {
						if (i_23_ >= 0
								&& i_23_ < this.anInt3154
										* -16196483)
	...
	public void method2738(int i, int i_27_, int i_28_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lz.n(").append(')').toString());
		}
	}

	/*
	 * public boolean method2739(int i, int i_29_, int i_30_, int i_31_, int
	 * i_32_, int i_33_, int i_34_, int i_35_, int i_36_) { try { if (i_30_ > 1)
	 * { if (Class287.method2720(i, i_29_, i_30_, i_30_, i_31_, i_32_, i_33_,
	 * i_34_, -173263894)) return true; return method2740(i, i_29_, i_30_,
	 * i_30_, i_31_, i_32_, i_33_, i_34_, i_35_, (byte) -47); } int i_37_ =
	 * i_33_ + i_31_ - 1; int i_38_ = i_34_ + i_32_ - 1; if (i >= i_31_ && i <=
	 * i_37_ && i_29_ >= i_32_ && i_29_ <= i_38_) return true; if (i == i_31_ -
	 * 1 && i_29_ >= i_32_ && i_29_ <= i_38_ && 0 == ((anIntArrayArray3155[i -
	 * 1487776559 * anInt3151][i_29_ - 1415525851 * anInt3152]) & 0x8) && (i_35_
	 * & 0x8) == 0) return true; if (1 + i_37_ == i && i_29_ >= i_32_ && i_29_
	 * <= i_38_ && ((anIntArrayArray3155[i - anInt3151 * 1487776559][i_29_ -
	 * anInt3152 * 1415525851]) & 0x80) == 0 && (i_35_ & 0x2) == 0) return true;
	 * if (i_32_ - 1 == i_29_ && i >= i_31_ && i <= i_37_ &&
	 * ((anIntArrayArray3155[i - anInt3151 * 1487776559][i_29_ - 1415525851 *
	 * anInt3152]) & 0x2) == 0 && 0 == (i_35_ & 0x4)) return true; if (i_29_ ==
	 * i_38_ + 1 && i >= i_31_ && i <= i_37_ && 0 == ((anIntArrayArray3155[i -
	 * anInt3151 * 1487776559][i_29_ - 1415525851 * anInt3152]) & 0x20) &&
	 * (i_35_ & 0x1) == 0) return true; return false; } catch (RuntimeException
	 * runtimeexception) { throw Class346.method4175(runtimeexception, new
	 * StringBuilder() .append("lz.z(").append(')').toString()); } }
	 */

	public boolean method2740(int i, int i_39_, int i_40_, int i_41_,
			int i_42_, int i_43_, int i_44_, int i_45_, int i_46_, byte i_47_) {
		try {
			int i_48_ = i + i_40_;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lz.y(").append(')').toString());
		}
	}

	public void method2741(int i, int i_60_, int i_61_, int i_62_,
			boolean bool, boolean bool_63_, byte i_64_) {
		try {
			int i_65_ = 256;
			if (bool)
				i_65_ |= 0x20000;
			...
			for (int i_66_ = i; i_66_ < i_61_ + i; i_66_++) {
				if (i_66_ >= 0
						&& i_66_ < 843157589 * this.anInt3153) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lz.p(").append(')').toString());
		}
	}

	public boolean method2742(int i, int i_68_, int i_69_, int i_70_,
			int i_71_, int i_72_, int i_73_, int i_74_) {
		try {
			if (1 == i_69_) {
				if (i_70_ == i && i_71_ == i_68_)
					return true;
			} else if (i_70_ >= i && i_70_ <= i_69_ + i - 1 && i_71_ >= i_71_
					&& i_71_ <= i_71_ + i_69_ - 1)
				return true;
			i -= 1487776559 * anInt3151;
			...
			if (1 == i_69_) {
				if (i_72_ == 0) {
					if (0 == i_73_) {
						...
						if (i == i_70_
								&& 1 + i_71_ == i_68_
								&& (anIntArrayArray3155[i][i_68_] & 0x2c0120) == 0)
							return true;
						if (i == i_70_
								&& i_68_ == i_71_ - 1
								&& (anIntArrayArray3155[i][i_68_] & 0x2c0102) == 0)
							return true;
					} else if (1 == i_73_) {
						...
						if (i_70_ - 1 == i
								&& i_68_ == i_71_
								&& 0 == (anIntArrayArray3155[i][i_68_] & 0x2c0108))
							return true;
						if (1 + i_70_ == i
								&& i_71_ == i_68_
								&& (anIntArrayArray3155[i][i_68_] & 0x2c0180) == 0)
							return true;
					} else if (2 == i_73_) {
						...
						if (i == i_70_
								&& i_68_ == 1 + i_71_
								&& 0 == (anIntArrayArray3155[i][i_68_] & 0x2c0120))
							return true;
						if (i == i_70_
								&& i_68_ == i_71_ - 1
								&& (anIntArrayArray3155[i][i_68_] & 0x2c0102) == 0)
						...
						if (i == 1 + i_70_
								&& i_71_ == i_68_
								&& 0 == (anIntArrayArray3155[i][i_68_] & 0x2c0180))
							return true;
					}
				}
				if (i_72_ == 2) {
					if (0 == i_73_) {
						...
						if (i_70_ - 1 == i
								&& i_71_ == i_68_
								&& (anIntArrayArray3155[i][i_68_] & 0x2c0108) == 0)
							return true;
						if (i == i_70_ && 1 + i_71_ == i_68_)
							return true;
				...
				if (9 == i_72_) {
					if (i_70_ == i && 1 + i_71_ == i_68_
							&& 0 == (anIntArrayArray3155[i][i_68_] & 0x20))
						return true;
					if (i == i_70_ && i_68_ == i_71_ - 1
							&& (anIntArrayArray3155[i][i_68_] & 0x2) == 0)
						return true;
					if (i_70_ - 1 == i && i_71_ == i_68_
							&& (anIntArrayArray3155[i][i_68_] & 0x8) == 0)
						return true;
					if (i == 1 + i_70_ && i_71_ == i_68_
							&& (anIntArrayArray3155[i][i_68_] & 0x80) == 0)
						return true;
				}
			} else {
				int i_75_ = i_69_ + i - 1;
				...
				if (0 == i_72_) {
					if (i_73_ == 0) {
						if (i_70_ - i_69_ == i && i_71_ >= i_68_
								&& i_71_ <= i_76_)
							return true;
						if (i_70_ >= i
								&& i_70_ <= i_75_
								&& i_68_ == i_71_ + 1
								&& 0 == (anIntArrayArray3155[i_70_][i_68_] & 0x2c0120))
							return true;
						if (i_70_ >= i
								&& i_70_ <= i_75_
								&& i_68_ == i_71_ - i_69_
								&& 0 == (anIntArrayArray3155[i_70_][i_76_] & 0x2c0102))
							return true;
					} else if (i_73_ == 1) {
						...
						if (i_70_ - i_69_ == i
								&& i_71_ >= i_68_
								&& i_71_ <= i_76_
								&& ((anIntArrayArray3155[i_75_][i_71_] & 0x2c0108) == 0))
							return true;
						if (i_70_ + 1 == i
								&& i_71_ >= i_68_
								&& i_71_ <= i_76_
								&& (anIntArrayArray3155[i][i_71_] & 0x2c0180) == 0)
							return true;
					} else if (i_73_ == 2) {
						...
						if (i_70_ >= i
								&& i_70_ <= i_75_
								&& i_71_ + 1 == i_68_
								&& ((anIntArrayArray3155[i_70_][i_68_] & 0x2c0120) == 0))
							return true;
						if (i_70_ >= i
								&& i_70_ <= i_75_
								&& i_71_ - i_69_ == i_68_
						...
						if (i == i_70_ + 1
								&& i_71_ >= i_68_
								&& i_71_ <= i_76_
								&& 0 == (anIntArrayArray3155[i][i_71_] & 0x2c0180))
							return true;
					}
				}
				if (2 == i_72_) {
					if (0 == i_73_) {
						if (i == i_70_ - i_69_ && i_71_ >= i_68_
								&& i_71_ <= i_76_)
							return true;
						if (i_70_ >= i && i_70_ <= i_75_ && i_68_ == 1 + i_71_)
							return true;
						...
						if (i == i_70_ - i_69_
								&& i_71_ >= i_68_
								&& i_71_ <= i_76_
								&& 0 == (anIntArrayArray3155[i_75_][i_71_] & 0x2c0108))
							return true;
						...
						if (i_70_ >= i
								&& i_70_ <= i_75_
								&& i_68_ == i_71_ - i_69_
								&& ((anIntArrayArray3155[i_70_][i_76_] & 0x2c0102) == 0))
							return true;
					} else if (i_73_ == 2) {
						if (i_70_ - i_69_ == i
								&& i_71_ >= i_68_
				...
				if (9 == i_72_) {
					...
					if (i_70_ - i_69_ == i
							...
							&& 0 == (anIntArrayArray3155[i_75_][i_71_] & 0x2c0108))
						return true;
					if (1 + i_70_ == i && i_71_ >= i_68_ && i_71_ <= i_76_
							&& (anIntArrayArray3155[i][i_71_] & 0x2c0180) == 0)
						return true;
				}
			}
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lz.s(").append(')').toString());
		}
	}

	public void method2743(int i, int i_77_, int i_78_, int i_79_,
			boolean bool, boolean bool_80_, byte i_81_) {
		try {
			i -= 1487776559 * anInt3151;
	...
	/*
	 * static final void method2745(Class403 class403, int i) { try {
	 * ((Class403) class403).anInt5245 -= -1365138610; if ((((Class403)
	 * class403).aLongArray5251[1685767703 * ((Class403) class403).anInt5245]) <
	 * (((Class403) class403).aLongArray5251[1685767703 * ((Class403)
	 * class403).anInt5245 + 1])) ((Class403) class403).anInt5259 +=
	 * ((((Class403) class403).anIntArray5257[1883543357 * ((Class403)
	 * class403).anInt5259]) * 286750741); } catch (RuntimeException
	 * runtimeexception) { throw Class346.method4175(runtimeexception, new
	 * StringBuilder() .append("lz.bo(").append(')').toString()); } }
	 * 
	 * static final void method2746(Class403 class403, int i) { try {
	 * ((Class403) class403).anInt5239 -= -783761378; int i_84_ = (((Class403)
	 * class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
	 * int i_85_ = (((Class403) class403).anIntArray5244[1 + ((Class403)
	 * class403).anInt5239 * 681479919]); ClientScriptMap class483 =
	 * Class51.aClass475_506.getClientScriptMap(i_84_, 1528209569); if ('s' ==
	 * class483.aChar6037) {
	 * 
	 * } ((Class403) class403).anObjectArray5240[((((Class403)
	 * class403).anInt5241 += 969361751) -203050393 - 1)] =
	 * class483.method6122(i_85_, (byte) -30); } catch (RuntimeException
	 * runtimeexception) { throw Class346.method4175(runtimeexception, new
	 * StringBuilder() .append("lz.vy(").append(')').toString()); } }
	 */
}
