...
public final class Huffman {
	...
	public static final void init() {
		byte[] huffmanFile = Cache.getCacheFileManagers()[10].getFileData(Cache.getCacheFileManagers()[10].getContainerId("huffman"), 0);
	...
	public static final int encryptMessage(int streamOffset,
	   ...
	   public static int sendEncryptMessage(OutputStream stream, String message) {
	    	try {
	    	    ...
	    	    stream.skip(encryptMessage
	    			       (stream.getOffset(), messageData.length, stream.getBuffer(),
	    				0, messageData));
	    ...
	    public static final String readEncryptedMessage(int maxLength, InputStream stream) {
			...
			stream.skip(decryptMessage
					   (messageData, messageDataLength, stream.getBuffer(), stream.getOffset(),
					    0));
