...
public class Foods {
	...
	public static enum Food {
		 ...
		 * Minigames
		 */
		 BANDAGE(4049, 0, Effect.BANDAGE_EFFECT), //heal 10% of hp lvl
	...
	public static enum Effect {
		...
		BANDAGE_EFFECT {
			...
			public void effect(Object object) {
				Player player = (Player) object;
				player.heal(10); //todo heal 10% of players hitpoints level
			}
		},
	...
	public static boolean eat(final Player player, Item item, int slot) {
		...
		player.heal(food.getHeal(), food.getExtraHP());
