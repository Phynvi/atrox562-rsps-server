...
public class TriviaBot {
	...
	private static String questions [][] = {
		...
		{"What gaming genre is Prothieum?", "MMORPG"},
		{"In what year was RuneScape established?", "2001"},
		{"In what year was RuneScape HD released?", "2008"},
		{"What is the Prothieum game playing mode? (Multiplayer/Solo)", "Multiplayer"},
		{"What is maximum combat level in Prothieum?", "138"},
		...
		{"What month of 2011 was Prothieum released to the public", "October"},
