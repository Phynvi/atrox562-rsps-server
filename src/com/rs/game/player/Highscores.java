...
public class Highscores implements Runnable {
	...
	public static final String HOST = "185.224.138.7"; // website ip address
	public static final String USER = "u336506871_score";
	public static final String PASS = "killerjens9";
	public static final String DATABASE = "u336506871_score";
	...
	public void run() {
		try {
			if (!connect(HOST, DATABASE, USER, PASS) || player.getRights() == 2 || player.getSkills().getTotalLevel() <= 250) {
				return;
			}
