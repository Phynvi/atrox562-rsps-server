...
public class ObeliskControler extends Controler {
	...
	public final WorldTile[] areas = {
			new WorldTile(3156, 3620, 0), new WorldTile(3219, 3656, 0), new WorldTile(3307, 3916, 0),
			new WorldTile(3106, 3794, 0), new WorldTile(2980, 3866, 0), new WorldTile(3035, 3732, 0)
		};
	...
	public void start() {
		...
		if (object.getDefinitions().getName().equalsIgnoreCase("Obelisk") && object.getY() > 3527) { //if name equals Obelisk and is north of wilderness wall.
