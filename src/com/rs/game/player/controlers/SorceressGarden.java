...
public class SorceressGarden extends Controler {
	...
	public enum Gate {
		...
		WINTER(21709, 1, new WorldTile(2902, 5470, 0), new WorldTile(2903, 5470, 0)),
		SPRING(21753, 25, new WorldTile(2921, 5473, 0), new WorldTile(2920, 5473, 0)),
		AUTUMN(21731, 45, new WorldTile(2913, 5462, 0), new WorldTile(2913, 5463, 0)),
		SUMMER(21687, 65, new WorldTile(2910, 5481, 0), new WorldTile(2910, 5480, 0));
