...
public class NewHomeController extends Controler {
	...
	private void getDroppedItems() {
		player.lock();		for (Item item : STARTER_ITEMS)
	...
	private void startNPCActions() {
		player.lock();		NPC1 = new NPC(1, new WorldTile(2966, 3386, 0), -1, true, true);
