...
public class LendingManager implements Serializable {
	...
	/*public static void ReturnedItems(Player player) {
		player.getInterfaceManager().sendInterface(772);
		player.getPackets().sendItemOnIComponent(772, 2, 1044, 1);
		player.getPackets().sendIComponentText(772, 13, "<col=00ff00>Available");
	}*/
	...
	public static void ReturnItem(Player player) {
		...
		player.getInterfaceManager().sendInterface(772);
		player.getPackets().sendItems(-1, 63762, 540, player.getInventory().getItems());
		player.getPackets().sendAccessMask(1026, 772, 10, -1, -1);
		player.getPackets().sendIComponentText(772, 13, "<col=db0000>"+ hours +" Hour, "+ minutes +" Minutes");
		}
	}
	...
	public static void unLend(Lend lend) {
		...
		if (lendee.getInventory().containsItem(lend.getItem().getDefinitions().getLendId(), 1)) {
			...
			lendee.getInventory().deleteItem(lend.getItem().getDefinitions().getLendId(), 1);
			if (lendeeLog)
	...
	public static void handleButtons(final Player player, int slotId) {
		...
		player.getPackets().sendRunScript(108, new Object[] { "How long do you wish to lend this item (in hours)?" });
	}
