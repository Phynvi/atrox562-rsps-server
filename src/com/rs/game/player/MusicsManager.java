...
public final class MusicsManager implements Serializable {
	...
	public void unlockMusicPlayer() {
		player.getPackets().sendUnlockIComponentOptionSlots(187, 1,
				0, LAST_MUSIC_ID, 0);
	...
	public void playMusic(int musicId) {
		...
		if (musicId == -2) {
			...
			player.getPackets().sendIComponentText(187, 14, "");
			return;
		}
