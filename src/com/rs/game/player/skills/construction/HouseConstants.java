...
public class HouseConstants {
	...
	public static enum Builds {
		...
		HELERY(15450, false, HObject.PLUMING_STAND, HObject.SHIELD_EASEL, HObject.BANNER_EASEL),
		ClockMaking(15441, false, HObject.CRAFTING_TABLE, HObject.CRAFTING_TABLE_2, HObject.CRAFTING_TABLE_3, HObject.CRAFTING_TABLE_4),
		REPAIRBENCH(15448, false, HObject.REPAIR_BENCH, HObject.WHETSTONE, HObject.ARMOURSTAND),
		TOOLS1(15446, false, HObject.TOOL_STORE1, HObject.TOOL_STORE2, HObject.TOOL_STORE3, HObject.TOOL_STORE4, HObject.TOOL_STORE5),
		TOOLS2(15444, false, HObject.TOOL_STORE1, HObject.TOOL_STORE2, HObject.TOOL_STORE3, HObject.TOOL_STORE4, HObject.TOOL_STORE5),
		TOOLS3(15443, false, HObject.TOOL_STORE1, HObject.TOOL_STORE2, HObject.TOOL_STORE3, HObject.TOOL_STORE4, HObject.TOOL_STORE5),
		TOOLS4(15445, false, HObject.TOOL_STORE1, HObject.TOOL_STORE2, HObject.TOOL_STORE3, HObject.TOOL_STORE4, HObject.TOOL_STORE5),
		TOOLS5(15447, false, HObject.TOOL_STORE1, HObject.TOOL_STORE2, HObject.TOOL_STORE3, HObject.TOOL_STORE4, HObject.TOOL_STORE5)
		...
		RUG_3(new int[] { 15266, 15265, 15264 }, false, HObject.BROWN_RUG, HObject.RUG, HObject.OPULENT_RUG)
		// KITCHEN
		,
		...
		// COSTUME ROOM
		,
		TREASURE_CHEST_SPACE(18813, false, HObject.OAK_TREASURE_CHEST, HObject.TEAK_TREASURE_CHEST, HObject.MAHOGANY_TREASURE_CHEST),
		ARMOUR_CASE(18815, false, HObject.OAK_ARMOUR_CASE, HObject.TEAK_ARMOUR_CASE, HObject.MAHOGANY_ARMOUR_CASE),
		WARDROBE2(18811, false, HObject.OAK_MAGIC_WARDDROBE, HObject.CARVED_OAK_MAGIC_WARDROBE, HObject.TEAK_MAGIC_WARDROBE, HObject.CARVED_TEAK_MAGIC_WARDROBE, HObject.MAHOGANY_MAGIC_WARDROBE, HObject.GILDED_MAGIC_WARDROBE, HObject.MARBLE_MAGIC_WARDROBE),
		CAPERACK(18810, false, HObject.OAK_CAPE_RACK, HObject.TEAK_CAPE_RACK, HObject.MAHOGANY_CAPE_RACK, HObject.GILDED_CAPE_RACK, HObject.MARBLE_CAPE_RACK, HObject.MAGICAL_CAPE_RACK),
		TOYBOX(18812, false, HObject.OAK_TOY_BOX, HObject.TEAK_TOY_BOX, HObject.MAHOGANY_TOY_BOX),
		COSTUMEBOX(18814, false, HObject.OAK_FANCY_DRESS_BOX, HObject.TEAK_FANCY_DRESS_BOX, HObject.MAHOGANY_FANCY_DRESS_BOX)
		...
		RUG_4(new int[] { 15274, 15273 }, false, HObject.RUG, HObject.OPULENT_RUG2),
		...
		HEDGING(new int[] { 15370, 15371, 15372, 13474, 13475 }, true, HObject.THORNY_HEDGE, HObject.NICE_HEDGE, HObject.SMALL_BOX_HEDGE, HObject.TOPIARY_HEDGE, HObject.FANCY_HEDGE, HObject.TALL_FANCY_HEDGE, HObject.TALL_BOX_HEDGE),
		...
		// TRAPS
		,
		PIT_TRAPS(36692, false, HObject.MINOR_PIT_TRAP, HObject.MAJOR_PIT_TRAP, HObject.SUPERIOR_PIT_TRAP),
		PIT_TRAP2(39229, false, HObject.MINOR_PIT_TRAP, HObject.MAJOR_PIT_TRAP, HObject.SUPERIOR_PIT_TRAP),
		PIT_TRAP3(39230, false, HObject.MINOR_PIT_TRAP, HObject.MAJOR_PIT_TRAP, HObject.SUPERIOR_PIT_TRAP),
		PIT_TRAP4(39231, false, HObject.MINOR_PIT_TRAP, HObject.MAJOR_PIT_TRAP, HObject.SUPERIOR_PIT_TRAP)
		// GUARDS
		,
		...
		// OUTBELITTE
		,
		OUTBELITTEGUARD(15354, false, HObject.SKELETON, HObject.GUARD_DOG, HObject.HOBGOBLIN, HObject.BABY_RED_DRAGON, HObject.HUGE_SPIDER, HObject.TROLL_GUARD, HObject.HELL_HOUND),
		FLOORSPACES(new int[] { 15349, 15348, 15347 }, false, HObject.SPIKES, HObject.TENTACLE_POOL),
		CAGESPACES(new int[] { 15352, 15353 }, false, HObject.OAK_CAGE, HObject.OAK_AND_STEEL_CAGE, HObject.STEEL_CAGE2, HObject.SPIKED_CAGE, HObject.BONE_CAGE),
		LADDERSPACE(15356, false, HObject.OAK_LADDER, HObject.TEAK_LADDER, HObject.MAHOGANY_LADDER)

		// DUNGEON DOORS
		,
		DOORS(new int[] { 15326, 15327 }, false, HObject.OAK_DOOR, HObject.STEEL_DOOR, HObject.MARBLE_DOOR),
		DOORS2(new int[] { 15328, 15329 }, false, HObject.OAK_DOOR, HObject.STEEL_DOOR, HObject.MARBLE_DOOR)

		// DUNGEON TRAPS
		,
		TRAP(15324, false, HObject.SPIKE_TRAP, HObject.MAN_TRAP, HObject.TANGLE_VINE, HObject.MARBLE_TRAP, HObject.TELEPOR_TRAP),
		TRAP2(15325, false, HObject.SPIKE_TRAP, HObject.MAN_TRAP, HObject.TANGLE_VINE, HObject.MARBLE_TRAP, HObject.TELEPOR_TRAP)

		,
		STAIRGUARD(15336, false, HObject.SKELETON, HObject.GUARD_DOG, HObject.HOBGOBLIN, HObject.BABY_RED_DRAGON, HObject.HUGE_SPIDER, HObject.TROLL_GUARD, HObject.HELL_HOUND),
		STAIRGUARD2(15337, false, HObject.SKELETON, HObject.GUARD_DOG, HObject.HOBGOBLIN, HObject.BABY_RED_DRAGON, HObject.HUGE_SPIDER, HObject.TROLL_GUARD, HObject.HELL_HOUND)
		// ALL LIGHTING
		,
		LIGHTING(34138, false, HObject.CANDLE, HObject.TORCH, HObject.SKULL_TORCH),
		LIGHTING2(15330, false, HObject.CANDLE, HObject.TORCH, HObject.SKULL_TORCH),
		LIGHTING3(15355, false, HObject.CANDLE, HObject.TORCH, HObject.SKULL_TORCH),
		DUNGDECORATION(15331, false, HObject.BLOOD, HObject.PIPE, HObject.SKELETONDEC);
	...
	public static enum HObject {
		...
		CHEFS_DELIGHT(8244, 13573, 36, 224, new Item(OAK_PLANK, 3), new Item(5755, 8), new Item(STEEL_BAR, 2))
		...
		CRAFTING_TABLE_4(8383, 13712, 42, 120, new Item(OAK_PLANK, 2))// clock
																		// shit.
		...
		ARMOURSTAND(8391, 13715, 55, 500, new Item(OAK_PLANK, 8), new Item(LIMESTONE_BRICKS, 1)),

		// Tool Space
		TOOL_STORE1(8384, 13699, 15, 120, new Item(OAK_PLANK, 2), new Item(GOLD_LEAF, 1)),
		TOOL_STORE2(8385, 13700, 25, 120, new Item(OAK_PLANK, 5), new Item(GOLD_LEAF, 1)),
		TOOL_STORE3(8386, 13701, 35, 120, new Item(TEAK_PLANK, 2), new Item(GOLD_LEAF, 1)),
		TOOL_STORE4(8387, 13702, 44, 120, new Item(TEAK_PLANK, 5), new Item(GOLD_LEAF, 1)),
		TOOL_STORE5(8388, 13703, 55, 120, new Item(MAHOGANY_PLANK, 10), new Item(GOLD_LEAF, 1)),

		// HELDERY SPACE
		PLUMING_STAND(8392, 13716, 16, 120, new Item(OAK_PLANK, 2)),
		SHIELD_EASEL(8393, 13717, 41, 120, new Item(OAK_PLANK, 5)),
		BANNER_EASEL(8394, 13718, 66, 120, new Item(TEAK_PLANK, 2)),
		...
		// MAGIC WARDROBE
		,
		OAK_MAGIC_WARDDROBE(9829, 18784, 42, 240, new Item(OAK_PLANK, 4)),
		...
		MAHOGANY_MAGIC_WARDROBE(9833, 18792, 78, 560, new Item(MAHOGANY_PLANK, 4)),
		GILDED_MAGIC_WARDROBE(9834, 18794, 87, 860, new Item(MAHOGANY_PLANK, 4), new Item(GOLD_LEAF, 1)),
		...
		MAHOGANY_CAPE_RACK(9819, 18768, 72, 560, new Item(MAHOGANY_PLANK, 4)),
		GILDED_CAPE_RACK(9820, 18769, 81, 860, new Item(MAHOGANY_PLANK, 4), new Item(GOLD_LEAF, 1)),
		MARBLE_CAPE_RACK(9821, 18770, 90, 500, new Item(MARBLE_BLOCK)),
		MAGICAL_CAPE_RACK(9822, 18771, 99, 1000, new Item(MAGIC_STONE))
		// TOY BOXES
		,
		OAK_TOY_BOX(9836, 18798, 50, 120, new Item(OAK_PLANK, 2)),
		TEAK_TOY_BOX(9837, 18799, 68, 180, new Item(TEAK_PLANK, 2)),
		MAHOGANY_TOY_BOX(9838, 18800, 86, 280, new Item(MAHOGANY_PLANK, 2))
		// DRESS BOXES
		,
		OAK_FANCY_DRESS_BOX(9823, 18772, 44, 120, new Item(OAK_PLANK, 2)),
		TEAK_FANCY_DRESS_BOX(9824, 18773, 62, 180, new Item(TEAK_PLANK, 2)),
		MAHOGANY_FANCY_DRESS_BOX(9825, 18774, 80, 280, new Item(MAHOGANY_PLANK, 2))
		...
		// RUGS
		,
		OPULENT_RUG2(8318, new int[] { 13594, 13595 }, 65, 360, new Item(BOLT_OF_CLOTH, 4), new Item(GOLD_LEAF, 1)),
		RUG2(8317, new int[] { 13591, 13592 }, 13, 60, new Item(BOLT_OF_CLOTH, 4))
		...
		SMALL_DAFFODILS(8211, 13441, 71, 100, new Item(8453)),
		SMALL_BLUEBELLS(8212, 13439, 76, 122, new Item(8455))
		// LARGE PLANT2
		,
		LARGE_ROSEMARY(8210, 13440, 66, 70, new Item(8451)),
		LARGE_DAFFODILS(8211, 13438, 71, 100, new Item(8453)),
		LARGE_BLUEBELLS(8212, 13442, 76, 122, new Item(8455))
		// HEDGING
		,
		THORNY_HEDGE(8203, new int[] { 13456, 13458, 13457 }, 56, 70, new Item(8437)),
		NICE_HEDGE(8204, new int[] { 13459, 13461, 13460 }, 60, 100, new Item(8439)),
		SMALL_BOX_HEDGE(8205, new int[] { 13462, 13464, 13463 }, 64, 122, new Item(8441)),
		TOPIARY_HEDGE(8206, new int[] { 13465, 13467, 13466 }, 68, 141, new Item(8443)),
		FANCY_HEDGE(8207, new int[] { 13468, 13470, 13469 }, 72, 158, new Item(8445)),
		TALL_FANCY_HEDGE(8208, new int[] { 13471, 13473, 13472 }, 76, 223, new Item(8447)),
		TALL_BOX_HEDGE(8209, new int[] { 13474, 13476, 13475 }, 80, 316, new Item(8449))
		// FENCING
		,
		...
		MAHOGANY_PET_HOUSE(15229, 44830, 67, 580, new Item(MAHOGANY_PLANK, 5)),
		CONSECRATED_PET_HOUSE(15230, 44831, 92, 1580, new Item(MAHOGANY_PLANK, 5), new Item(MAGIC_STONE, 1)),
		DESECRATED_PET_HOUSE(15231, 44832, 92, 1580, new Item(MAHOGANY_PLANK, 5), new Item(MAGIC_STONE, 1)),
		NATURAL_PET_HOUSE(15232, 44833, 92, 1580, new Item(MAHOGANY_PLANK, 5), new Item(MAGIC_STONE, 1))
		// HABITAT
		,
		...
		MAHOGANY_PET_FEEDER(15235, 44836, 67, 880, new Item(MAHOGANY_PLANK, 4), new Item(GOLD_LEAF))
		...
		SKELETON_THRONE(8361, 13669, 88, 7003, new Item(8788, 5), new Item(MARBLE_BLOCK, 4), new Item(526, 5), new Item(964, 2)),
		CRYSTAL_THRONE(8362, 13670, 95, 15000, new Item(8788, 15)),
		DEMONIC_THRONE(8363, 13671, 99, 25000, new Item(8788, 25))
		// TRAPDOOR
		,
		...
		// FLOOR DECORATIONS
		,
		FLOOR_DECORATION(8370, new int[] { 13685, 13685, 13685, 13685 }, 61, 700, new Item(MAHOGANY_PLANK, 5)),
		STEEL_CAGE(8371, new int[] { 13685, 13685, 13685, 13685 }, 68, 1100, new Item(MAHOGANY_PLANK, 5), new Item(STEEL_BAR, 20)),
		TRAPDOOR(8372, new int[] { 13689, 13689, 13689, 13689 }, 74, 770, new Item(MAHOGANY_PLANK, 5), new Item(8792, 10)),
		LESSER_MAGIC(8373, new int[] { 13685, 13685, 13685, 13685 }, 82, 2700, new Item(MAHOGANY_PLANK, 5), new Item(8788, 2)),
		GREATER_MAGIC(8374, new int[] { 13685, 13685, 13685, 13685 }, 89, 4700, new Item(MAHOGANY_PLANK, 5), new Item(8788, 4))
		// DUNGEON
		// TRAPS
		,
		SPIKE_TRAP(8143, 13356, 72, 223, new Item(995, 50000)),
		MAN_TRAP(8144, 13357, 76, 273, new Item(995, 75000)),
		TANGLE_VINE(8145, 13358, 80, 316, new Item(995, 10000)),
		MARBLE_TRAP(8146, 13359, 84, 387, new Item(995, 150000)),
		TELEPOR_TRAP(8147, 13360, 88, 447, new Item(995, 200000))
		// DECORATION
		,
		BLOOD(8125, 13312, 72, 4, new Item(1763, 4)),
		PIPE(8126, 13311, 83, 120, new Item(2353, 6)),
		SKELETONDEC(8127, 13310, 94, 3, new Item(553, 2), new Item(526, 6))
		// DOORS
		,
		OAK_DOOR(8122, new int[] { 13344, 13345 }, 74, 600, new Item(OAK_PLANK, 10)),
		STEEL_DOOR(8123, new int[] { 13346, 13347 }, 84, 800, new Item(OAK_PLANK, 10), new Item(STEEL_BAR, 10)),
		MARBLE_DOOR(8124, new int[] { 13348, 13349 }, 94, 2000, new Item(MARBLE_BLOCK, 4))

		// OUTBELLITE
		,
		SPIKES(8302, new int[] { 13336, 13335, 13334 }, 65, 623, new Item(995, 75640)),
		TENTACLE_POOL(8303, new int[] { 13333, 13332, 13331 }, 71, 326, new Item(995, 101660)),
		FLAME_PIT(8304, new int[] { 13337, 13337, 13337 }, 77, 357, new Item(995, 200000)),
		...
		STEEL_CAGE2(8299, new int[] { 13319, 13320 }, 75, 400, new Item(STEEL_BAR, 20)),
		...
		KALPHITESOILDER(8139, 13374, 80, 866, new Item(995, 750000)),
		...
		// PIT TRAP
		,
		MINOR_PIT_TRAP(18797, 39266, 71, 304, new Item(995, 65000)),
		MAJOR_PIT_TRAP(18798, 39268, 83, 1000, new Item(995, 202500)),
		SUPERIOR_PIT_TRAP(18799, 39270, 96, 1100, new Item(995, 989500))
		// PIT GUARDIAN
		,
		PIT_DOG(18791, 39260, 70, 200, new Item(995, 40000)),
		PIT_ORGE(18792, 39261, 73, 234, new Item(995, 55000)),
		PIT_ROCK_PROTECTOR(18793, 39262, 79, 300, new Item(995, 90000)),
		PIT_SCABARITE(18794, 39263, 84, 387, new Item(995, 150000)),
		PIT_BLACK_DEMON(18795, 39264, 89, 547, new Item(995, 300000)),
		PIT_IRON_DRAGON(18796, 39265, 97, 2738, new Item(995, 7500000))

		// HALLWAY GUARDS
		// GUARDS
		,
		SKELETON(8131, 13366, 70, 223, new Item(995, 50000)),
		GUARD_DOG(8132, 13367, 74, 273, new Item(995, 75000)),
		HOBGOBLIN(8133, 13368, 78, 316, new Item(995, 100000)),
		BABY_RED_DRAGON(8134, 13372, 82, 387, new Item(995, 150000)),
		HUGE_SPIDER(8135, 13370, 86, 447, new Item(995, 200000)),
		TROLL_GUARD(8136, 13369, 90, 1000, new Item(995, 1000000)),
		...
		SKULL_TORCH(8130, 13343, 94, 246, new Item(OAK_PLANK, 3), new Item(594, 4), new Item(24257, 4))
	...
	public static int[] WINDOW_IDS = new int[] { 13730, 13728, 13733, 13729, 13733, 13731, 13732 };// 13012
																									// should
																									// be
																									// correct
																									// for
