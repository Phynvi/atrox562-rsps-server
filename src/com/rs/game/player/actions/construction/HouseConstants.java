...
public class HouseConstants {
	...
	public static enum HObject {
		...
		// REPAIR BENCH
		REPAIR_BENCH(8389, 13713, 15, 120, new Item(OAK_PLANK, 2)), WHETSTONE(
				8390, 13714, 35, 260, new Item(OAK_PLANK, 4), new Item(
						LIMESTONE_BRICKS, 1)), ARMOUR_STAND(8391, 13715, 55,
								500, new Item(OAK_PLANK, 8), new Item(LIMESTONE_BRICKS, 1))
								// HERALDRY
								, PLUMING_STAND(8392, 13716, 16, 120, new Item(OAK_PLANK, 2)), SHIELD_EASEL(
										8393, 13717, 41, 240, new Item(OAK_PLANK, 4)), BANNER_EASEL(
												8394, 13718, 66, 510, new Item(OAK_PLANK, 8), new Item(
														BOLT_OF_CLOTH, 2))
														// TOOL MOUNT
														, TOOL_STORE_1(8384, 13699, 15, 120, new Item(OAK_PLANK, 2)), TOOL_STORE_2(
																8385, 13700, 25, 120, new Item(OAK_PLANK, 4)), TOOL_STORE_3(
																		8386, 13701, 35, 120, new Item(OAK_PLANK, 6)), TOOL_STORE_4(
																				8387, 13702, 44, 120, new Item(OAK_PLANK, 8)), TOOL_STORE_5(
																						8388, 13703, 55, 121, new Item(OAK_PLANK, 10)), VARROCKP(8330, 13629, 80, 1500, new Item(MARBLE_BLOCK, 3), new Item(
																								563, 100), new Item(554, 100), new Item(556, 300)), LUMBRIDGEP(
																										8330, 13630, 80, 1500, new Item(MARBLE_BLOCK, 3), new Item(563,
																												100), new Item(557, 100), new Item(556, 300)), FALADORP(
																														8330, 13631, 80, 1500, new Item(MARBLE_BLOCK, 3), new Item(563,
																																100), new Item(555, 100), new Item(556, 300)), CAMELOTP(
																																		8330, 13632, 80, 1500, new Item(MARBLE_BLOCK, 3), new Item(563,
																																				100), new Item(556, 500)), ARDOUGNEP(8330, 13633, 80,
																																						1500, new Item(MARBLE_BLOCK, 3), new Item(563, 200), new Item(
																																								555, 200)), YANILLEP(8330, 13634, 80, 1500, new Item(
																																										MARBLE_BLOCK, 3), new Item(563, 200), new Item(557, 200)), KHARYRLLP(
																																												8330, 13635, 80, 1500, new Item(MARBLE_BLOCK, 3), new Item(563,
																																														200), new Item(565, 200))
	...
	public static enum Roof {
		...
		ROOF3(236, 633, RegionBuilder.NORTH, RegionBuilder.EAST, RegionBuilder.SOUTH, RegionBuilder.NORTH),
	...
	public static enum POHLocation {
		...
		PRIFDDINAS(new WorldTile(2168, 3335, 1), 75, 50000);
