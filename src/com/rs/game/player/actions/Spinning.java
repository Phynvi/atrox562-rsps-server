...
public class Spinning {
	...
	/*
	*Gets the spinning wheel object
	*/
	private static WorldObject object;
	public static WorldObject getObject() {
		return object;
	}
     ...
     */
    public static void spin(Player player, SpinningItem item, int itemId) {
		...
		//World.sendObjectAnimation(getObject(), new Animation(466));
		player.getPackets().sendObjectAnimation(new WorldObject(36970, 10, 0, 3209, 3212, 1), new Animation(466));
