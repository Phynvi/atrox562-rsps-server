...
public class DungeonExit extends Dialogue {
	...
	public void start() {
		...
		sendDialogue(SEND_2_TEXT_CHAT, "", "This ladder leads back to the surface. You will not be able", "to come back to this dungeon if you leave.");
	...
	public void run(int interfaceId, int componentId) {
		if(stage == -1) {
			sendDialogue(SEND_2_LARGE_OPTIONS,
					"Leave the dungeon and return to the surface?",
					"Yes."
					,"No.");
			stage = 0;
		}else if (stage == 0) {
