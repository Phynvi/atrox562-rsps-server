	...
	public void run(int interfaceId, int componentId) {
		if(stage == -1) {
			...
			sendEntityDialogue(SEND_1_TEXT_CHAT,
					new String[] { player.getDisplayName(), "I would like to buy an Attack skillcape." },
                ...
                if (player.getSkills().getLevel(Skills.ATTACK) == 99) {
                	...
                	sendEntityDialogue(SEND_2_TEXT_CHAT, new String[] {
							NPCDefinitions.getNPCDefinitions(npcId).name,
							"Looks like you don't have a level of 99 attack,",
							"you need a level of 99 attack to buy one."
							}, IS_NPC, npcId, 9827);;
                }
		}else if(stage == 100) {
end();
			...
			if(componentId == 1) {
				...
				player.getInventory().addItem(9747,1);
