	...
	public void run(int interfaceId, int componentId) {
		if(stage == -1) {
			...
			sendEntityDialogue(SEND_1_TEXT_CHAT,
					new String[] { player.getDisplayName(), "I would like to buy a summoning skillcape." },
                ...
                if (player.getSkills().getLevel(Skills.SUMMONING) == 99) {
                	...
                	sendEntityDialogue(SEND_3_TEXT_CHAT, new String[] {
							NPCDefinitions.getNPCDefinitions(npcId).name,
							"Anybody who has spent as much time summoning as", 
                	...
                	sendEntityDialogue(SEND_2_TEXT_CHAT, new String[] {
							NPCDefinitions.getNPCDefinitions(npcId).name,
							"Looks like you don't have a level of 99 summoning,",
							"you need a level of 99 summoning to buy one."
							}, IS_NPC, npcId, 9827);;
                }
		}else if(stage == 100) {
end();
			...
			if(componentId == 1) {
				...
				player.getInventory().addItem(12169,1);
				player.getInventory().addItem(12171,1);
				}
				}else
				end();
