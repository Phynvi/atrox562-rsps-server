	...
	public static final void init() {
		try {
			...
			Class<Cutscene> value7 = (Class<Cutscene>) Class
					.forName(WolfWhistle.class.getCanonicalName());
			handledCutscenes.put("WolfWhistle", value7);
			Class<Cutscene> value8 = (Class<Cutscene>) Class
					.forName(WolfWhistle1.class.getCanonicalName());
			handledCutscenes.put("WolfWhistle1", value8);
		} catch (Throwable e) {
			Logger.handle(e);
		}
	}
