...
public enum CityAchievements {

    KARAMJA("Karamja", 11, new String[][] {
            {
    ...
    LUMBRIDGE("Lumbridge/Draynor", 2, new String[][]{
     ...
     */
    CityAchievements(String name, int child, String[][] achievements, Item[][] rewards, String info, int[] npcs) {
        this.name = name;
        this.child = child;
     ...
     */
    public static CityAchievements forChild(int child) {
        for (CityAchievements type : values()) {
            for (int i = 0; i < 4; i++) {
