...
public class DesertWyrmCombat extends CombatScript {

	@Override
	public Object[] getKeys() {
		return new Object[] { 6831, 6832 };
	}
	...
	public int attack(final NPC npc, final Entity target) {
		...
		if (usingSpecial) {// priority over regular attack
			npc.setNextAnimation(new Animation(7795));
			...
			delayHit(
					...
					getMagicHit(
							npc,
							getRandomMaxHit(npc, 40, NPCCombatDefinitions.MELEE,
									target)));
