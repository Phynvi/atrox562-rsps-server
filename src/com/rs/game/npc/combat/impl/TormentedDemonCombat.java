	...
	public int attack(NPC npc, Entity target) {
		...
		case 0:
			if (npc.withinDistance(target, 3)) {
				hit = getRandomMaxHit(npc, 18, NPCCombatDefinitions.MELEE,
						target);
		...
		case 1:
			hit = getRandomMaxHit(npc, 27, NPCCombatDefinitions.MAGE, target);
			...
			break;
		case 2:
			hit = getRandomMaxHit(npc, 27, NPCCombatDefinitions.RANGE, target);
