...
public class BarkerToad extends CombatScript {

	@Override
	public Object[] getKeys() {
		return new Object[] { 6889, 6890 };
	}
	...
	public int attack(final NPC npc, final Entity target) {
		...
		if (usingSpecial) {// priority over regular attack
			...
			npc.setNextAnimation(new Animation(8292));
			delayHit(npc, 1, target, getMagicHit(npc, getRandomMaxHit(npc, 40, NPCCombatDefinitions.MELEE, target)));
		}
